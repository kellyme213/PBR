...
//                            irradiance: simd_float3(5.0, 3.0, 0.0),
//                            lightRadius: 0.0)
        
        scene.addAreaLight(position: simd_float3(0.0, 1.8, 0.0), direction: simd_float3(-1.0, -1.0, 0.0), irradiance: simd_float3(10.0, 10.0, 10.0), lightRadius: 10.0, extent: simd_float2(0.2, 0.2))
    }
}
